...
| 10 | Расписание преподавателя | 🟡 | импорт готов целиком: парсер (T-39), HTTP-обёртка (T-40), таблицы и модель (T-41a), клиент (T-41b), ручка `POST /api/teachers/{id}/schedule/import` (T-41c). Осталось чтение — публичные ручки (T-42) |
