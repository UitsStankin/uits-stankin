...
| 21 | Загрузка файлов (аватары/превью) | 🟡 | upload с ресайзом и превью новости готовы (T-22, T-23); аватар преподавателя пишется через карточку (T-26); аватар пользователя сохранять по-прежнему некуда — T-33 |
