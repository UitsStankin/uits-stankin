...
| 15 | Научные публикации + теги | ✅ | — (T-50a, T-50b: справочник тегов, карточки публикаций с фильтрами по тегу, автору и году, CRUD модератору; PDF в хранилище вместо base64 в базе, загрузка через `POST /api/files` — T-50c) |
