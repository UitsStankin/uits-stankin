...
Паритет **12 модулей из 23**. Готово: аутентификация (JWT), профиль со сменой пароля
...
расписание преподавателя (T-39…T-42a: разбор PDF микросервисом, импорт админом,
публичное чтение).
