...
Паритет **13 модулей из 23**. Готово: аутентификация (JWT), профиль со сменой пароля
...
* **Тестов.** Ноль. Условие «не раньше, чем устоится паттерн списочной страницы»
  снято вместе с F-14 — паттерн есть, и первые кандидаты названы в D-F4.
