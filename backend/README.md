...
один сотрудник УВП, три новости и три объявления о конференциях. И в новостях,
и в конференциях одна запись скрыта флагом `display=false` — публичные списки
отдают по две, и это способ проверить, что фильтр видимости работает.
