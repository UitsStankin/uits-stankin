 ...
 * только чтение — тем же правилом живёт `entities/news`: и правка своей
 * карточки, и модераторский CRUD лежат в фиче `features/manage-teachers`.
 *
 * Обе публичные ручки читает и админка: своего списка у модератора
 * в контракте нет, а форма правки догружает полную карточку детальной —
 * в списке нет ни дисциплин, ни ключа фото, ни связи с учётной записью.
 */
