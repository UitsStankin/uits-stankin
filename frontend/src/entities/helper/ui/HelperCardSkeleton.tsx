/**
 * Серый силуэт карточки УВП на время первой загрузки.
 *
 * Лежит рядом с `HelperCard` и обязан повторять её раскладку — круг
 * сверху, две строки под ним, те же отступы, — иначе в момент ответа
 * сетка дёрнется по высоте.
 *
