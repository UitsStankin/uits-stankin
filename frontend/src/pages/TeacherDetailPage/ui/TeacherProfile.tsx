 ...
 * расписание, дисциплины, публикации, достижения. Из них данные сегодня
 * есть у двух: расписание преподавателя — Фаза 2, достижения — F-25,
 * публикации — Фаза 4. Вкладки, три из которых пусты, хуже разделов
 ...
 * Достижения и расписание встанут сюда же новыми блоками.
 *
 * ### Пустые поля
 *
