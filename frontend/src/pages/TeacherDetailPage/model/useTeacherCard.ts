...
export function useTeacherCard() {
  ...
  return {
    ...
    /**
     * Разобранный `id` из адреса. Наружу выходит ради блока достижений:
     * он ходит за ними по тому же идентификатору и не должен разбирать
     * адрес второй раз — две копии разбора разъехались бы на первом же
     * мусорном адресе.
     */
    id,
