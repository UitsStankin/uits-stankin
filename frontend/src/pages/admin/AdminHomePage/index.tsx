 ...
 * намеренно: разделов девять, готовы из них два, и редирект в один
 * из них прятал бы карту работ, которую эта витрина как раз и показывает.
 * Плитки заодно дают вход в разделы с телефона, где меню сворачивается
 * в ленту.
 */
