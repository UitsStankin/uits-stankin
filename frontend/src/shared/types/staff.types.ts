 ...
 * `/api/teachers/me`.
 *
 * Ключа файла аватара здесь нет — только готовый адрес. Для формы правки
 * это дыра: `PUT` — полная замена и ждёт в `avatar` именно ключ
 * (см. `features/edit-teacher-card/lib/avatarKey.ts`).
 */
